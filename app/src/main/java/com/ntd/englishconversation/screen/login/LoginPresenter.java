...
import static com.ntd.englishconversation.data.source.local.sharedprf.SharedPrefsKey.PREF_EMAIL;
import static com.ntd.englishconversation.data.source.local.sharedprf.SharedPrefsKey
        .PREF_PASSWORD;
