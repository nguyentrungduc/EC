package com.ntd.englishconversation.record;
...
import com.ntd.englishconversation.record.model.AudioChannel;
import com.ntd.englishconversation.record.model.AudioSampleRate;
...
import static com.ntd.englishconversation.record.AndroidAudioRecorder.EXTRA_FILE_NAME;
import static com.ntd.englishconversation.record.AndroidAudioRecorder.EXTRA_FILE_PATH;
...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            fileName = savedInstanceState.getString(EXTRA_FILE_NAME);
            source =
                (AudioSource) savedInstanceState.getSerializable(AndroidAudioRecorder.EXTRA_SOURCE);
            channel = (AudioChannel) savedInstanceState.getSerializable(
                AndroidAudioRecorder.EXTRA_CHANNEL);
            sampleRate = (AudioSampleRate) savedInstanceState.getSerializable(
                AndroidAudioRecorder.EXTRA_SAMPLE_RATE);
            ...
            source =
                (AudioSource) getIntent().getSerializableExtra(AndroidAudioRecorder.EXTRA_SOURCE);
            channel =
                (AudioChannel) getIntent().getSerializableExtra(AndroidAudioRecorder.EXTRA_CHANNEL);
            sampleRate = (AudioSampleRate) getIntent().getSerializableExtra(
                AndroidAudioRecorder.EXTRA_SAMPLE_RATE);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(EXTRA_FILE_NAME, fileName);
    ...
    private void resumeRecording() {
        ...
        if (recorder == null) {
            ...
            recorder = OmRecorder.wav(
                new PullTransport.Default(Util.getMic(source, channel, sampleRate),
                    AudioRecorderActivity.this), new File(filePath));
        }
