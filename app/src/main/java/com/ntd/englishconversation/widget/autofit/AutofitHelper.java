package com.ntd.englishconversation.widget.autofit;
...
public class AutofitHelper {
    ...
    public static AutofitHelper create(TextView view, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            minTextSize =
                    ta.getDimensionPixelSize(R.styleable.AutofitTextView_minTextSize, minTextSize);
    ...
    private static int getLineCount(CharSequence text, TextPaint paint, float size, float width,
        ...
        StaticLayout layout =
                new StaticLayout(text, paint, (int) width, Layout.Alignment.ALIGN_NORMAL, 1.0f,
                        0.0f, true);
