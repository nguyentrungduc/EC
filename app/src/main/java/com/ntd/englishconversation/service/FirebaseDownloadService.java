package com.ntd.englishconversation.service;
...
/**
 * Created by framgia on 12/05/2017.
 */
...
public class FirebaseDownloadService extends BaseStorageService {
    ...
    private void downloadFromPath(final String downloadPath) {
        ...
        // Mark task started
        taskStarted();
        showProgressNotification(PROGRESS_DOWNLOAD, 0, 0);
        ...
        mStorageRef.child(downloadPath).getStream(new StreamDownloadTask.StreamProcessor() {
            ...
            public void doInBackground(StreamDownloadTask.TaskSnapshot taskSnapshot,
                ...
                while ((size = inputStream.read(buffer)) != -1) {
                    ...
                    showProgressNotification(PROGRESS_DOWNLOAD, bytesDownloaded, totalBytes);
                }
    ...
    private boolean broadcastDownloadFinished(String downloadPath, long bytesDownloaded) {
        ...
        Intent broadcast = new Intent(action).putExtra(EXTRA_DOWNLOAD_PATH, downloadPath)
    ...
    private void showDownloadFinishedNotification(String downloadPath, int bytesDownloaded) {
        ...
        Intent intent =
                new Intent(this, MainActivity.class).putExtra(EXTRA_DOWNLOAD_PATH, downloadPath)
                        .putExtra(EXTRA_BYTES_DOWNLOADED, bytesDownloaded)
